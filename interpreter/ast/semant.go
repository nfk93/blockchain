	...
	case BinOpExp:
		...
		case DIVIDE:
			...
			case KOIN:
				switch rightTyped.Type.Type() {
				case KOIN:
					return TypedExp{texp, OptionType{NewTupleType([]Type{NewNatType(), NewKoinType()})}}, venv, tenv, senv, gas
				case NAT:
					return TypedExp{texp, OptionType{NewTupleType([]Type{NewKoinType(), NewKoinType()})}}, venv, tenv, senv, gas
				default:
					return TypedExp{texp,
